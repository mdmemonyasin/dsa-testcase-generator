...
SYSTEM_PROMPT = """\
You are an expert competitive programmer writing production-quality C++17 solutions.
...
4. Must compile cleanly with: g++ -O2 -std=c++17 -o output/solution output/solution.cpp
...
class SolutionAgent(BaseAgent):
    def run(self, problem_text: str) -> str:
        ...
        out_path = os.path.join("output", "solution.cpp")
